    ...
    <section className="bg-[#f9fafb] py-6 sm:py-8 md:py-10 px-4 sm:px-6 md:px-8 height box-shadow">
      <div className="container mx-auto">
        <div className="flex items-center justify-between">
          <h2 className="md:text-2xl sm:text-base text-black uppercase font-semibold">Students Details</h2>
          <button onClick={() => navigate('/add-student')} className="main-btn font-semibold px-3 py-1 sm:px-4 sm:py-2 text-sm sm:text-base rounded-lg">Add Student</button>
        </div>
        <div className="my-5">
